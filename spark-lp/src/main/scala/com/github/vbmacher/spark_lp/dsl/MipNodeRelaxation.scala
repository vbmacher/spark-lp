...
private[dsl] final class MipNodeRelaxation(
  base: Compiled, nodeRhs: DenseVector,
  cuts: Vector[MipCoverCut], lower: Array[Double], upper: Array[Double]
